...
initial_guess = [6, 6, 5, 5, 80, 80]  # Example initial guess for [wing_area, fuselage_length, SW2, SW3, V2, V3]
...
if optimizer_result.success:
    ...
    print(f"Optimal V2: {round(best_V2, 2)} ft/s")
    print(f"Optimal V3: {round(best_V3, 2)} ft/s")
